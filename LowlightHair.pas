...
var
  FormLowlightHair: TFormLowlightHair;
...
procedure TFormLowlightHair.Button1Click(Sender: TObject);
var a,b,x,z:integer;
y:real;
begin
x:=0;
...
procedure TFormLowlightHair.FormClose(Sender: TObject; var Action: TCloseAction);
begin
